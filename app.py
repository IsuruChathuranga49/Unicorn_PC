...
# Integrates Intelligent Build, Manual Build, and Performance Prediction
...
# Import Firebase for Manual Build (Optional - only if serviceAccountKey.json exists)
try:
...
# Manual Build API Endpoints - Using Firebase Database
...
if __name__ == '__main__':
    print("="*60)
    print("🦄 Unicorn PC Builder - Starting Server")
    print("="*60)
